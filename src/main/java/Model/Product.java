...
public class Product {
    ...
    public boolean compareTo(Product q){
        ...
        if(category.compareTo(q.getCategory())!=0) return false;
        if(quantity!=q.getQuantity()) return false;
        if(code!=q.getCode()) return false;
        if(supplier.compareTo(q.getSupplier())!=0) return false;
        return true;
    }
    ...
    public String toString() {
        return "Product [code=" + code + ", name=" + name + ", category="
                + category + ", supplier=" + supplier + ", quantity=" + quantity + "]";
    }
